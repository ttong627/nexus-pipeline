...
- ★**품질모니터 재측정(2026-08-23 15:1x · `--no-send`, 텔레그램·monitor.log 미기록)** — 수치가 08-17 과 전혀 다르다. 원인은 **명단 구성 교체**:
  ...
  - 괄호잡값 73 = 같은 A-38 과(한 글자 파편)가 **다른 08 명단에도** 있다. 복구 도구 dry-run: **성남 중원 22(보류 4) · 시흥 13(보류 2) · 부천 원미 5(보류 1)** —
    ⛔쓰기는 형 "고" 대기. 나머지는 숫자 파편(`신설동, 8652`×9 · `401`·`204`·`2`)·`B`·`신천동, 신천동`(중복) — 도구 범위 밖, 별도 판단.
