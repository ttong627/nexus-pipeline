...
> **P2 완료(37,045건·buildingMgtNo 100%)** · P1 재실행 15건. 정화 누적 **211건**.
...
## ▶ 남은 후보 (형 승인 대기)
1. `--allow-majority` 다수결 통일 — 79그룹/128건(127건이 빈 건물명 채우기). `백산/벽산` 1건만 판단 필요.
2. 보류 102그룹 개별 검토 — 동률·근소차·깨끗한 후보 없음.
3. 규격화 서버 이관(설계안 존재) — 측정 결과 시급성 낮음.
