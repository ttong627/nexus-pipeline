...
import { normalizeCommonRoadTypos } from '../../services/address-service/src/shared/roadTokens.js';
...
// P7 Phase2 ⓑ-2: A-17·18·19·23 잔여 상세/도로명 정규화 순수 유닛 — 클라·서버 공용 SSOT.
import {
  ROAD_ADDRESS_RE,
  PHONE_IN_ADDR_RE,
...
} from '../../services/address-service/src/shared/detailNormalize.js';
// P7 Phase2 ⓒ-1: 지역매칭·공통상수·도로명파서·Kakao 순수변환·주민센터 검색어 — 클라·서버 공용 SSOT.
import {
