...
import { Database, UploadCloud, Loader2, Sparkles, Settings2, LayoutDashboard } from 'lucide-react';

export default function Step1_Upload({ handleDragOver, handleDrop, handleFileUpload, handleUnifiedDrop, isBaseUploading, step, onHelp, onCloudFetch, onOpenDashboard, cleanMode = 'easy', setCleanMode }) {
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              ...
              >
                ...
                <p className="text-[13px] text-gray-400 leading-relaxed">파일만 올리면 칼럼을 자동 매칭 → 애매한 것만 한 번 확인 → 바로 정제 완료</p>
              </button>
              <button
              ...
              >
                ...
                <p className="text-[13px] text-gray-400 leading-relaxed">시트 선택·컬럼 매핑을 직접 확인하고 세밀하게 조정합니다</p>
              </button>
            </div>
          </div>
          ...
          >
            ...
            {isBaseUploading ? (
              <div className="relative mb-6">
                <Loader2 size={60} className="text-emerald-400 animate-spin" />
              </div>
            ) : (
              <div className="relative mb-6">
